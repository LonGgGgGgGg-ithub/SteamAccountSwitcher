# -*- coding: UTF-8 -*-
# https://github.com/LonGgGgGgGg-ithub/SteamAccountSwitcher
...
class Window(QMainWindow):
    ...
    def __init__(self):
        ...
        self.init_ui()
        self.m_flag = False
        self.cfg_path = '../SteamAccountSwitcher/rename.ini'
    ...
    def openGithub(self):
        # 打开url
        webopen('https://github.com/LonGgGgGgGg-ithub/SteamAccountSwitcher')
        pass
    ...
    # 关闭主程序
    def quitMain(self):
        with open('../SteamAccountSwitcher/rename.ini', 'w', encoding='utf-8')as f:  # 写入rename.ini
